export const poseInstructions = {
    ...
    Arkana_Dhanurasana:[
       ' Lie flat on your stomach.',
        'Keep legs straight and arms by your sides.',
'Bend your right knee and bring the heel toward your buttocks.',
'Hold your right ankle with your right hand.',
'Inhale and lift your chest and right leg off the floor.',
'Keep your gaze forward.',
'Balance on your left arm and left leg.',
'Hold the pose for 15–30 seconds while breathing deeply.',
'Exhale and gently release the leg and arm.',
"Relax for a few breaths.",
"Repeat the same steps on the left side." ],
Bharadwajasana:[
'    Sit with legs extended (Dandasana).',
'Bend knees and bring feet to the right side of hips.',
'Sit on the left hip, right ankle in left foot arch.',
'Inhale, lengthen the spine.',
'Exhale, twist torso to the left.',
'Left hand behind back, right hand on left knee.',
'Keep shoulders relaxed, gaze over left shoulder.',
